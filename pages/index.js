...
export default function Home() {
      ...
      return (
        <main data-scroll-section className={`h-screen w-screen relative `}>
          <ImageCarousel />
          <div className={'absolute bottom-[20vh] sm:bottom-[10vh] left-0 sm:left-4 h-fit sm:ml-[8%] pl-[2%] font-semibold text-2xl sm:text-[5.5vw] uppercase leading-none '}>
            <motion.h1 layoutId={'title'}> justincrediblemoments </motion.h1>
            <h1> &quot;the portfolio&quot; </h1>
          </div>
          <div className={'absolute top-[8vh] font-medium sm:w-[30vw] w-[80vw]  left-0 sm:left-[10%] pl-2 sm:pl-4 2xl:w-[25vw] 2xl:text-3xl whitespace-normal '}>
