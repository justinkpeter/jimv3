...
export function SocialLinks() {
	...
	return (
		<>
			<div className={'fixed bottom-[3vh] sm:bottom-[10vh] md:bottom-[2vh] right-[5vw] sm:right-[2vw] z-50 flex gap-4 text-xs sm:text-[2vw] xl:text-sm 2xl:text-lg uppercase'}>
